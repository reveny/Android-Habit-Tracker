...
interface HabitRepository {
    ...
    suspend fun logFailure(habitId: Long, date: String, note: String? = null, failureTime: String? = null)
    suspend fun insertLogRaw(habitId: Long, date: String, note: String? = null, failureTime: String? = null): Long
